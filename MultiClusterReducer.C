...
vector<vector<float>> MultiClusterReducer(vector<float>, vector<float>,vector<float>, vector<float>,vector<float>, vector<float>,vector<float>, vector<float>,vector<float>, vector<float>,vector<float>, vector<float>,vector<float>, vector<float>,vector<float>, vector<float>);


vector<vector<float>> MultiClusterReducer(vector<float>  Tracker1xmaxstrips, vector<float>  Tracker1xmaxcharges,vector<float>  Tracker1ymaxstrips, vector<float>  Tracker1ymaxcharges,vector<float>  Tracker2xmaxstrips, vector<float>  Tracker2xmaxcharges,vector<float>  Tracker2ymaxstrips, vector<float>  Tracker2ymaxcharges,vector<float>  Tracker3xmaxstrips, vector<float>  Tracker3xmaxcharges,vector<float>  Tracker3ymaxstrips, vector<float>  Tracker3ymaxcharges,vector<float>  Tracker4xmaxstrips, vector<float>  Tracker4xmaxcharges,vector<float>  Tracker4ymaxstrips, vector<float>  Tracker4ymaxcharges){
  ...
  //do need atleast 2 trackers with 1 hit in them to reconstruct an inital line, then the residual of the multi hits in each other trackers is calculated and only the hit with the lowest residual is returned as the correct hit.
